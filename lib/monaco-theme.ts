...
export function registerEditorTheme(monaco: { editor: typeof editor }) {
  ...
  const lightTokens: editor.ITokenThemeRule[] = [
    ...
    { token: 'comment.doc', foreground: toMonacoTokenHex(synComment, 'a3a3a3'), fontStyle: 'italic' },
    ...
    { token: 'keyword.operator', foreground: toMonacoTokenHex(synOperator, '525252') },
    { token: 'storage', foreground: toMonacoTokenHex(synKeyword, '7c3aed') },
    { token: 'storage.modifier', foreground: toMonacoTokenHex(synKeyword, '7c3aed') },
    ...
    { token: 'string.template', foreground: toMonacoTokenHex(synString, '16a34a') },
    { token: 'number', foreground: toMonacoTokenHex(synNumber, 'b45309') },
    { token: 'number.hex', foreground: toMonacoTokenHex(synNumber, 'b45309') },
    { token: 'number.float', foreground: toMonacoTokenHex(synNumber, 'b45309') },
    { token: 'regexp', foreground: toMonacoTokenHex(synRegexp, 'dc2626') },
    { token: 'type', foreground: toMonacoTokenHex(synType, '0891b2'), fontStyle: 'italic' },
    { token: 'type.identifier', foreground: toMonacoTokenHex(synType, '0891b2'), fontStyle: 'italic' },
    { token: 'class', foreground: toMonacoTokenHex(synType, '0891b2'), fontStyle: 'italic' },
    { token: 'interface', foreground: toMonacoTokenHex(synType, '0891b2'), fontStyle: 'italic' },
    { token: 'enum', foreground: toMonacoTokenHex(synType, '0891b2') },
    { token: 'namespace', foreground: toMonacoTokenHex(synType, '0891b2') },
    { token: 'module', foreground: toMonacoTokenHex(synType, '0891b2') },
    ...
    { token: 'support.function', foreground: toMonacoTokenHex(synFunction, '2563eb') },
    { token: 'entity.name.function', foreground: toMonacoTokenHex(synFunction, '2563eb') },
    ...
    { token: 'variable.parameter', foreground: toMonacoTokenHex(synVariable, '171717'), fontStyle: 'italic' },
    { token: 'parameter', foreground: toMonacoTokenHex(synVariable, '171717'), fontStyle: 'italic' },
    { token: 'property', foreground: toMonacoTokenHex(synFunction, '2563eb') },
    { token: 'constant', foreground: toMonacoTokenHex(synConstant, 'b45309') },
    { token: 'constant.language', foreground: toMonacoTokenHex(synVariablePredef, 'dc2626') },
    { token: 'enumMember', foreground: toMonacoTokenHex(synConstant, 'b45309') },
    { token: 'decorator', foreground: toMonacoTokenHex(synKeyword, '7c3aed'), fontStyle: 'italic' },
    { token: 'annotation', foreground: toMonacoTokenHex(synKeyword, '7c3aed'), fontStyle: 'italic' },
    { token: 'tag', foreground: toMonacoTokenHex(synTag, 'dc2626') },
    { token: 'tag.id', foreground: toMonacoTokenHex(synTag, 'dc2626') },
    ...
    { token: 'delimiter.bracket', foreground: toMonacoTokenHex(synDelimiter, '525252') },
    { token: 'delimiter.curly', foreground: toMonacoTokenHex(synDelimiter, '525252') },
    { token: 'delimiter.parenthesis', foreground: toMonacoTokenHex(synDelimiter, '525252') },
    { token: 'operator', foreground: toMonacoTokenHex(synOperator, '525252') },
    { token: 'punctuation', foreground: toMonacoTokenHex(synDelimiter, '525252') },
  ]

  const darkTokens: editor.ITokenThemeRule[] = [
    { token: 'comment', foreground: toMonacoTokenHex(synComment, '666666'), fontStyle: 'italic' },
    { token: 'comment.doc', foreground: toMonacoTokenHex(synComment, '666666'), fontStyle: 'italic' },
    ...
    { token: 'keyword.operator', foreground: toMonacoTokenHex(synOperator, '999999') },
    { token: 'storage', foreground: toMonacoTokenHex(synKeyword, 'c084fc') },
    { token: 'storage.modifier', foreground: toMonacoTokenHex(synKeyword, 'c084fc') },
    ...
    { token: 'string.template', foreground: toMonacoTokenHex(synString, '86efac') },
    { token: 'number', foreground: toMonacoTokenHex(synNumber, 'fbbf24') },
    { token: 'number.hex', foreground: toMonacoTokenHex(synNumber, 'fbbf24') },
    { token: 'number.float', foreground: toMonacoTokenHex(synNumber, 'fbbf24') },
    { token: 'regexp', foreground: toMonacoTokenHex(synRegexp, 'f87171') },
    { token: 'type', foreground: toMonacoTokenHex(synType, '67e8f9'), fontStyle: 'italic' },
    { token: 'type.identifier', foreground: toMonacoTokenHex(synType, '67e8f9'), fontStyle: 'italic' },
    { token: 'class', foreground: toMonacoTokenHex(synType, '67e8f9'), fontStyle: 'italic' },
    { token: 'interface', foreground: toMonacoTokenHex(synType, '67e8f9'), fontStyle: 'italic' },
    { token: 'enum', foreground: toMonacoTokenHex(synType, '67e8f9') },
    { token: 'namespace', foreground: toMonacoTokenHex(synType, '67e8f9') },
    { token: 'module', foreground: toMonacoTokenHex(synType, '67e8f9') },
    ...
    { token: 'support.function', foreground: toMonacoTokenHex(synFunction, '93c5fd') },
    { token: 'entity.name.function', foreground: toMonacoTokenHex(synFunction, '93c5fd') },
    ...
    { token: 'variable.parameter', foreground: toMonacoTokenHex(synVariable, 'e5e5e5'), fontStyle: 'italic' },
    { token: 'parameter', foreground: toMonacoTokenHex(synVariable, 'e5e5e5'), fontStyle: 'italic' },
    { token: 'property', foreground: toMonacoTokenHex(synFunction, '93c5fd') },
    { token: 'constant', foreground: toMonacoTokenHex(synConstant, 'fbbf24') },
    { token: 'constant.language', foreground: toMonacoTokenHex(synVariablePredef, 'fca5a5') },
    { token: 'enumMember', foreground: toMonacoTokenHex(synConstant, 'fbbf24') },
    { token: 'decorator', foreground: toMonacoTokenHex(synKeyword, 'c084fc'), fontStyle: 'italic' },
    { token: 'annotation', foreground: toMonacoTokenHex(synKeyword, 'c084fc'), fontStyle: 'italic' },
    { token: 'tag', foreground: toMonacoTokenHex(synTag, 'f87171') },
    { token: 'tag.id', foreground: toMonacoTokenHex(synTag, 'f87171') },
    ...
    { token: 'delimiter.bracket', foreground: toMonacoTokenHex(synDelimiter, '999999') },
    { token: 'delimiter.curly', foreground: toMonacoTokenHex(synDelimiter, '999999') },
    { token: 'delimiter.parenthesis', foreground: toMonacoTokenHex(synDelimiter, '999999') },
    { token: 'operator', foreground: toMonacoTokenHex(synOperator, '999999') },
    { token: 'punctuation', foreground: toMonacoTokenHex(synDelimiter, '999999') },
  ]
  ...
  monaco.editor.defineTheme('code-editor', {
    ...
    colors: {
      ...
      'diffEditor.insertedLineBackground': additions + '0d',
      'diffEditor.removedLineBackground': deletions + '0d',
      ...
      'editorGhostText.foreground': fgTertiary,
      'editorInlayHint.foreground': fgTertiary,
      'editorInlayHint.background': bgSubtle + '80',
      'editorCodeLens.foreground': fgTertiary,
      'editorBracketHighlight.foreground1': brand + 'cc',
      'editorBracketHighlight.foreground2': brand + '99',
      'editorBracketHighlight.foreground3': brand + '66',
      'editorBracketHighlight.unexpectedBracket.foreground': deletions,
      'editorWarning.foreground': expandShortHex(getCSSVar('--warning', dark ? '#f59e0b' : '#b45309')),
      'editorError.foreground': deletions,
      'editorInfo.foreground': additions,
    },
  })
}
